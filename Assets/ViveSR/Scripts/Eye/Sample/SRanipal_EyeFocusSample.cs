    ...
    public class SRanipal_EyeFocusSample : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            foreach (GazeIndex index in GazePriority)
            {
                ...
                if (eye_focus)
                {
                    //FocusInfo.transform.gameObject.GetComponent<Renderer>().material.color = Color.yellow;
                    fixedPoint = FocusInfo.transform.gameObject.GetComponent<Transform>().position;
                    Cubie cubie = FocusInfo.transform.GetComponent<Cubie>();
                    //if (dartBoard != null) dartBoard.Focus(FocusInfo.point);
                    //if (cubie != null)
                    //{
                    //    cubie.Targeted(FocusInfo.transform.gameObject.name);
                    //}
                    //break;
                }
                else 
